...
export interface Equipment { id:string; nome:string; slot:Slot; preco:number; ataque:number; vida:number; defesa:number; habilidade:string; imagem:string; arte?:string; raridade?:Rarity; classeExclusiva?:'guerreiro'|'guardiao'|'cacadora'|'arcanista'|'druida'|'cacador'; tipoEquipamento?:string; nivelMinimo?:number; capacidade?:number; elemento?:Element; resistencia?:Element }
