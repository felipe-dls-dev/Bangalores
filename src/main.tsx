...
const REGION_LIST_ORDER:Record<string,number>={campos_dourados:1,floresta_lunargenta:2,khar_dur:3,montanhas_cinzentas:4,pico_escarlate:5,terras_mortas:6,coracao_eclipse:7}
function regionListSort(a:Territory,b:Territory){return (REGION_LIST_ORDER[a.id]??a.dificuldade)-(REGION_LIST_ORDER[b.id]??b.dificuldade)||a.dificuldade-b.dificuldade}
