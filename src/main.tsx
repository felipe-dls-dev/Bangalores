   ...
   <Panel title="Ações" className="combat-actions-panel combat-actions-area">
      ...
      <div className="combat-actions-grid">
       ...
       <div className="stance-row" role="group" aria-label="Postura de combate">
        <button className={`premium-action${currentStance==='ofensiva'?' active-toggle':''}`} disabled={disabled} title="Postura Ofensiva: +20% de Ataque e -20% de Defesa até trocar de postura." onClick={()=>performSetStance('ofensiva')}><Swords/>Ofensiva</button>
        <button className={`premium-action${currentStance==='neutra'?' active-toggle':''}`} disabled={disabled} title="Postura Neutra: sem bônus ou penalidade de Ataque/Defesa." onClick={()=>performSetStance('neutra')}><Scale/>Neutra</button>
        <button className={`premium-action${currentStance==='defensiva'?' active-toggle':''}`} disabled={disabled} title="Postura Defensiva: +20% de Defesa e -20% de Ataque até trocar de postura." onClick={()=>performSetStance('defensiva')}><ShieldHalf/>Defensiva</button>
       </div>
