...
function ForgeTutorialPanel(){
 ...
 const attunementDetails:Record<GameElement,{condition:string;impact:string;influence:string;armor:string}>={
  ...
  gelo:{condition:'Congelado',impact:'no crítico da arma, o inimigo fica Congelado e sofre penalidade nas rolagens de ataque e defesa por 2 turnos.',influence:'reduz a qualidade das rolagens do inimigo; é uma condição de controle.',armor:'na armadura, reduz dano de gelo recebido e bloqueia Congelamento.'},
  ...
  sombra:{condition:'Agarrado',impact:'no crítico da arma, o inimigo fica Agarrado e sofre penalidade nas rolagens de ataque e defesa por 2 turnos.',influence:'é uma condição de controle que atrapalha a resposta do inimigo.',armor:'na armadura, reduz dano de sombra recebido e bloqueia Agarramento.'},
  luz:{condition:'Cego',impact:'no crítico da arma, o inimigo fica Cego e sofre penalidade nas rolagens de ataque e defesa por 1 turno.',influence:'enfraquece a precisão do inimigo e abre janela para pressão.',armor:'na armadura, reduz dano de luz recebido e bloqueia Cegueira.'},
