...
function CombatScreen(){
 ...
 const useCoopItemSkill=(equipmentId?:string)=>{if(g.itemSkillUsed||!myTurn)return;const item=itemAbilities.find(x=>x.id===equipmentId)??itemAbilities[0];if(!item)return;const txt=item.habilidade.toLowerCase()
