...
function GuildScreen(){
 ...
 const completed=GUILD_MISSIONS.filter(m=>g.guildAccepted.includes(m.id)&&!g.guildClaimed.includes(m.id)&&(g.guildProgress[m.id]??0)>=m.quantidade).length
