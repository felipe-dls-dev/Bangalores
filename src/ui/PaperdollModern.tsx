...
import { emptyItemStats, formatItemStats } from '../data/equipmentAttributes'
          ...
          <div>
            ...
            {equippedItem && (
              <span className="pd-stats">
                {equippedItem.slot === 'bolsa' ? `Capacidade ${equippedItem.capacidade ?? 8}` : formatItemStats(equippedTotal ?? emptyItemStats())}
              </span>
            )}
          </div>
