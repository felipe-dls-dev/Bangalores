  ...
  ,craftEquipment:(recipeId?:string,choice?:ForgeChoice)=>{
   ...
   set({
    ...
    ...(success?{
     ...
     ...(isAttribute&&gem&&targetRef?{equipmentGems:{...s.equipmentGems,[targetRef]:[gem.id]},forgedGemLocked:{...s.forgedGemLocked,[targetRef]:true}}:{}),
     ...(forgedRef?(item.slot==='mao_direita'?{equipmentElements:{...s.equipmentElements,[forgedRef]:forgedElement}}:{equipmentResistances:{...s.equipmentResistances,[forgedRef]:forgedElement}}):{})
    }:{}),
