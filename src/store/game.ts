...
function applyDefeatPenalty(set:any,get:any,reason='Você foi derrotado.'){
 ...
 const defeatKey=(s.enemy?.nome??'').replace(/^Vingança \d+: /,'').replace(/^(Veterano|Elite|Campeão): /,'')
