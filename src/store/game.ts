...
export const GUILD_MISSIONS:GuildMission[]=[
 {id:'caca_inicial',nome:'Limpeza das Estradas',descricao:'Derrote quaisquer 3 monstros nas terras de Havendown.',tipo:'any',quantidade:3,local:'Estrada dos Campos Dourados',destinoId:'campos_estrada',recompensa:{tipo:'gold',valor:12},dificuldade:1,rank:'ferro'},
