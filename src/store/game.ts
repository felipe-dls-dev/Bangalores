...
function applyDefeatPenalty(set:any,get:any,reason='Você foi derrotado.'){
 ...
 set({screen:s.subregionId?'region':'map',subregionId:undefined,explorationNote:penalty,gold:s.gold-goldLost,equipped,equipmentBag,equipmentUpgrades,equipmentGems,craftedEffects,hp:recoveredHp,enemy:undefined,enemyHp:0,combatMinions:[],pendingAttackBonus:0,shield:0,braced:false,fervor:0,combatRoll:undefined,fleeRoll:undefined,heroRollBonus:0,enemyRollBonus:0,animating:false,animationActor:undefined,lastDamage:undefined,playerTurn:false})
}
