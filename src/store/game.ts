...
import { DIFFICULTIES, REGION_MATERIALS, STORY_CHAPTERS, TALENTS, type DifficultyMode } from '../data/expansion'
...
interface GameState {
 ...
 difficultyMode:DifficultyMode;talents:string[];materials:Record<string,number>;equipmentUpgrades:Record<string,number>;bestiary:Record<string,{encontros:number;vitorias:number}>;revengeWins:Record<string,number>;dungeonDepth:number;dungeonActive:boolean;storyFlags:string[];storyChapterId:string;storyChoices:Record<string,string>;storyNotice?:string;
 ...
 setDifficulty:(mode:DifficultyMode)=>void;unlockTalent:(id:string)=>void;craftEquipment:()=>void;upgradeEquipment:(id:string)=>void;dismantleEquipment:(id:string)=>void;startDungeon:()=>void;leaveDungeon:()=>void;startRevenge:(subregionId:string)=>void;chooseStory:(choiceId:string)=>void;
}
