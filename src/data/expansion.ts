...
export const STATUS_INFO=[['Envenenado (natureza)','Sofre dano ao fim de cada turno por algumas rodadas.'],['Pegando fogo (fogo)','Sofre dano ao fim de cada turno por algumas rodadas.'],['Sangrando (físico)','Sofre dano ao fim de cada turno por algumas rodadas.'],['Congelado (gelo)','Penaliza todas as rolagens de ataque e defesa do afetado por algumas rodadas.'],['Agarrado (sombra)','Penaliza todas as rolagens de ataque e defesa do afetado por algumas rodadas.'],['Cego (luz)','Penaliza todas as rolagens de ataque e defesa do afetado por algumas rodadas.'],['Atordoado (arcano)','Cancela a próxima defesa do afetado ou faz com que perca a próxima ação — o que ocorrer primeiro.']] as const
