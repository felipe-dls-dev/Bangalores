...
export const EXTRA_EQUIPMENT:Equipment[] = [
 eq('espada_aurora','Espada da Primeira Aurora','mao_direita',38,7,0,0,'Luz nascente: o primeiro ataque causa +2 de dano.','assets/art/hd/equipment-extra/espada_aurora-hd.webp','epico'),
 eq('martelo_khardur','Martelo dos Salões de Kholgard','mao_direita',34,5,2,0,'Tremor anão: golpes ignoram parte da defesa inimiga.','assets/art/hd/equipment-extra/martelo_khardur-hd.webp','raro'),
 eq('adaga_nevoa','Adaga da Névoa Silenciosa','mao_direita',25,4,0,0,'Passo oculto: vantagem no primeiro turno.','assets/art/hd/equipment-extra/adaga_nevoa-hd.webp','raro'),
 eq('cajado_monolito','Cajado do Monólito Partido','mao_direita',31,6,3,0,'Eco rúnico: fortalece bênçãos recebidas em eventos.','assets/art/hd/equipment-extra/cajado_monolito-hd.webp','epico'),
 eq('escudo_eldrimar','Escudo da Ponte de Eldrimar','mao_esquerda',23,0,2,4,'Posição firme: recebe +1 de escudo no início do combate.','assets/art/hd/equipment-extra/escudo_eldrimar-hd.webp','raro'),
 ...
 eq('armadura_draconica','Armadura de Escamas Rubras','peitoral',46,0,8,5,'Resistência ígnea: proteção contra criaturas do Pico de Ignaris.','assets/art/hd/equipment-extra/armadura_draconica-hd.webp','lendario'),
 ...
 eq('elmo_vigia','Elmo do Vigia sem Sono','capacete',28,1,2,3,'Vigilância: evita emboscadas comuns.','assets/art/hd/equipment-extra/elmo_vigia-hd.webp','raro'),
 eq('coroa_espinhos','Coroa dos Espinhos Negros','capacete',35,2,2,4,'Retaliação sombria: devolve parte do primeiro golpe.','assets/art/hd/equipment-extra/coroa_espinhos-hd.webp','epico'),
 eq('grevas_avalanche','Grevas da Avalanche','calcas',27,0,3,4,'Passo pesado: concede estabilidade nas montanhas.','assets/art/hd/equipment-extra/grevas_avalanche-hd.webp','raro'),
 eq('calcas_nevoa','Calças do Batedor da Névoa','calcas',21,1,2,2,'Caminho oculto: melhora fugas de combate.','assets/art/hd/equipment-extra/calcas_nevoa-hd.webp','incomum'),
 eq('botas_caminhos','Botas dos Sete Caminhos','botas',30,1,2,3,'Marcha incansável: recupera vigor após exploração.','assets/art/hd/equipment-extra/botas_caminhos-hd.webp','raro'),
 eq('botas_magma','Botas de Cinza Vulcânica','botas',33,1,3,4,'Pés em brasa: afinidade com o Pico de Ignaris.','assets/art/hd/equipment-extra/botas_magma-hd.webp','epico'),
 ...
 eq('manto_rainha','Manto da Rainha sem Trono','peitoral',44,1,7,4,'Majestade perdida: aumenta recompensas de chefes.','assets/art/hd/equipment-extra/manto_rainha-hd.webp','lendario'),
 eq('espada_leao_valoria','Espada do Leão de Valoria','mao_direita',18,2,1,0,'Bravura real: fortalece o primeiro ataque.','assets/art/hd/class-weapons/espada_leao_valoria-hd.webp','incomum'),
 eq('espada_juramento_solar','Espada do Juramento Solar','mao_direita',25,3,0,0,'Juramento radiante: causa dano adicional contra mortos-vivos.','assets/art/hd/class-weapons/espada_juramento_solar-hd.webp','raro'),
 eq('espada_sangue_real','Espada do Sangue Real','mao_direita',42,8,2,0,'Linhagem soberana: poder máximo quando a vida está cheia.','assets/art/hd/class-weapons/espada_sangue_real-hd.webp','lendario'),
 ...
 eq('lamina_cinzas','Lâmina das Cinzas Eternas','mao_direita',31,6,0,0,'Brasa persistente: o primeiro golpe queima o alvo.','assets/art/hd/class-weapons/lamina_cinzas-hd.webp','epico'),
 eq('lamina_cavaleiro','Lâmina do Cavaleiro Sem Nome','mao_direita',24,5,1,0,'Honra esquecida: concede resistência ao lutar sozinho.','assets/art/hd/class-weapons/lamina_cavaleiro-hd.webp','raro'),
 eq('machado_pico','Machado do Pico Partido','mao_direita',32,7,2,0,'Ruptura da montanha: golpes pesados quebram defesas.','assets/art/hd/class-weapons/machado_pico-hd.webp','epico'),
 ...
 eq('machado_inverno','Machado do Inverno Imóvel','mao_direita',26,4,2,0,'Gelo imóvel: reduz o ímpeto do inimigo.','assets/art/hd/class-weapons/machado_inverno-hd.webp','raro'),
 eq('martelo_muralha','Martelo da Muralha Viva','mao_direita',23,6,3,0,'Muralha viva: concede proteção ao atacar.','assets/art/hd/class-weapons/martelo_muralha-hd.webp','raro'),
 eq('martelo_trovao','Martelo do Trovão Subterrâneo','mao_direita',43,8,3,0,'Trovão profundo: o primeiro impacto reverbera.','assets/art/hd/class-weapons/martelo_trovao-hd.webp','lendario'),
 eq('martelo_bastiao','Martelo do Último Bastião','mao_direita',17,2,3,0,'Última defesa: fica mais forte com pouca vida.','assets/art/hd/class-weapons/martelo_bastiao-hd.webp','incomum'),
 eq('facas_lua','Facas da Lua Gêmea','mao_direita',26,5,0,0,'Dança lunar: dois cortes no primeiro ataque.','assets/art/hd/class-weapons/facas_lua-hd.webp','raro'),
 ...
 eq('facas_trilha','Facas da Trilha Rubra','mao_direita',23,6,1,0,'Rastro rubro: facilita perseguir inimigos em fuga.','assets/art/hd/class-weapons/facas_trilha-hd.webp','raro'),
 eq('adaga_sussurro','Adaga do Sussurro Verde','mao_direita',18,3,1,0,'Sussurro da mata: afinidade com Abdendriel.','assets/art/hd/class-weapons/adaga_sussurro-hd.webp','incomum'),
 eq('adaga_aranha','Adaga da Aranha Prateada','mao_direita',32,7,0,0,'Veneno prateado: enfraquece o alvo após o golpe.','assets/art/hd/class-weapons/adaga_aranha-hd.webp','epico'),
 eq('adaga_rastro','Adaga do Último Rastro','mao_direita',41,8,1,0,'Caçada perfeita: recompensa ataques precisos.','assets/art/hd/class-weapons/adaga_rastro-hd.webp','lendario'),
 eq('cajado_estrelas','Cajado das Sete Estrelas','mao_direita',27,5,2,0,'Conjunção: fortalece bênçãos arcanas.','assets/art/hd/class-weapons/cajado_estrelas-hd.webp','raro'),
 eq('cajado_biblioteca','Cajado da Biblioteca Ardente','mao_direita',18,3,1,0,'Tomo em chamas: preserva magia de eventos.','assets/art/hd/class-weapons/cajado_biblioteca-hd.webp','incomum'),
 eq('cajado_tempo','Cajado do Tempo Fraturado','mao_direita',44,8,2,0,'Instante roubado: altera o ritmo do primeiro turno.','assets/art/hd/class-weapons/cajado_tempo-hd.webp','lendario'),
 eq('orbe_tempestade','Orbe da Tempestade Cativa','mao_direita',32,7,0,0,'Relâmpago cativo: descarga no primeiro ataque.','assets/art/hd/class-weapons/orbe_tempestade-hd.webp','epico'),
 eq('orbe_veu','Orbe do Véu Esquecido','mao_direita',17,2,1,0,'Véu arcano: reduz o primeiro dano recebido.','assets/art/hd/class-weapons/orbe_veu-hd.webp','incomum'),
 eq('orbe_sol_morto','Orbe do Sol Morto','mao_direita',25,4,1,0,'Eclipse: poder aumenta contra chefes.','assets/art/hd/class-weapons/orbe_sol_morto-hd.webp','raro')
]
...
const eventNames=[
 ...
 ['altar_lobos','O Altar dos Lobos','ataque',2,'Um juramento selvagem fortalece o próximo combate.'],['ponte_quebrada','A Ponte Quebrada','ouro_risco',5,'Atravesse as ruínas e alcance uma carga abandonada.'],['chuva_rubi','A Chuva de Rubis','ouro',6,'Fragmentos vermelhos caem sobre o Pico de Ignaris.'],['peregrino_sem_rosto','O Peregrino sem Rosto','escudo',3,'O viajante concede uma proteção de origem desconhecida.'],['banquete_fadas','O Banquete das Fadas','cura',5,'Aceite o alimento feérico e recupere suas forças.'],
