...
export const EXTRA_EQUIPMENT:Equipment[] = [
 ...
 eq('armadura_draconica','Armadura de Escamas Rubras','peitoral',46,0,8,3,'Resistência ígnea: proteção contra criaturas do Pico de Ignaris.','assets/art/hd/equipment-extra/armadura_draconica-hd.webp','lendario'),
 ...
 eq('botas_magma','Botas de Cinza Vulcânica','botas',33,1,3,1,'Pés em brasa: afinidade com o Pico de Ignaris.','assets/art/hd/equipment-extra/botas_magma-hd.webp','epico'),
