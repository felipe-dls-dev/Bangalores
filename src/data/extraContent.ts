...
export const EXTRA_EQUIPMENT:Equipment[] = [
 ...
 eq('martelo_khardur','Martelo dos Salões de Kholgard','mao_direita',34,2,2,0,'Tremor anão: golpes ignoram parte da defesa inimiga.','assets/art/hd/equipment-extra/martelo_khardur-hd.webp','raro'),
 ...
 eq('adaga_sussurro','Adaga do Sussurro Verde','mao_direita',18,1,1,0,'Sussurro da mata: afinidade com Abdendriel.','assets/art/hd/class-weapons/adaga_sussurro-hd.webp','incomum'),
