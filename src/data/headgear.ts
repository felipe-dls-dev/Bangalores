...
export const CLASS_HEADGEAR:Equipment[]=[
 ...
 ...make('arcanista','diadema_arcano',[
  ['diadema_estrelas','Diadema das Sete Estrelas','arc_estrelas.webp'],['diadema_chama','Diadema da Chama Silenciosa','arc_chama.webp'],['coroa_veu','Coroa do Véu Violeta','arc_veu.webp'],['diadema_runas','Diadema das Runas Quebradas','arc_runas.webp'],['coroa_tempestade','Coroa da Tempestade Azul','arc_tempestade.webp'],['diadema_tempo','Diadema do Tempo Perdido','arc_tempo.webp'],['coroa_lua_morta','Coroa da Lua Morta','arc_lua.webp'],['diadema_primeiro_arcanista','Diadema do Primeiro Mago','arc_primeiro.webp']])
]
